...
_STUD_DATA = load_json("student_data.json", fallback={})
ATTENDANCE = _STUD_DATA.get("attendance", {})
MARKS      = _STUD_DATA.get("marks", [])
EVENTS     = _STUD_DATA.get("events", [])
FEES       = _STUD_DATA.get("fees", [])
PROFILE    = _STUD_DATA.get("profile", {})
