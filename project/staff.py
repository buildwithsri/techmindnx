...
_STAFF_DATA = load_json("staff_data.json", fallback={})
DEPARTMENTS    = _STAFF_DATA.get("departments", ["CSE", "ECE", "ME", "CE", "EEE"])
BATCHES        = _STAFF_DATA.get("batches", ["2022-26", "2023-27", "2024-28", "2021-25"])
SECTIONS       = _STAFF_DATA.get("sections", [])
SUBJECTS       = _STAFF_DATA.get("subjects", [])
STUDENTS       = _STAFF_DATA.get("students", [])
SUBJ_NAMES_CSE = _STAFF_DATA.get("cse_subjects", [
