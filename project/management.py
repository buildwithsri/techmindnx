...
_MGMT_DATA = load_json("management_data.json", fallback={})
DEPARTMENTS = _MGMT_DATA.get("departments", ["CSE", "ECE", "ME", "CE", "EEE", "Admin", "LIB"])
ROLES       = _MGMT_DATA.get("roles", ["Faculty", "HOD", "Admin", "Librarian", "Lab Staff"])
SEED_STAFF  = _MGMT_DATA.get("seed_staff", [])
SEED_STUDENTS = _MGMT_DATA.get("seed_students", [])
